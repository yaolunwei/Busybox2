...
import static com.bigoat.http.Utils.checkNotNull;

/**
 * A single invocation of a Service service interface method. This class captures both the method
 * that was called and the arguments to the method.
 *
 * <p>Service automatically adds an invocation to each OkHttp request as a tag. You can retrieve
 ...
 * for concurrent access. For best results declare Service service interfaces using only immutable
